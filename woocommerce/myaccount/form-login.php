...
$col = 6;
$register = array_key_exists('register', $_GET);
?>
...
<div class="u-columns col2-set row" id="customer_login">
	...
	<div class="u-column1 col-md-<?php echo (int) $col; ?>">
		...
		<p><a href="?">Already have an account? Click here to login.</a></p>
...
<div class="u-columns col2-set row" id="customer_login">
	<div class="u-column1 col-md-<?php echo (int) $col; ?>">
		<h2><?php esc_html_e( 'Registration Disabled', 'woocommerce' ); ?></h2>
		<p>Registration is not allowed at this time</p>
	</div>
</div>
